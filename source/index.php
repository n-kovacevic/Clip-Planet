        ...
        <main>
            ...
            <div id="video_container">
                <?php
                    ...
                    $result=mysqli_query($link, "select * from videos order by date desc");
                    ...
                    while($res= mysqli_fetch_assoc($result)){
                        ...
                        echo  '<article>
                                ...
                                <div id="info">
                                    <p id="title"><a href="watch.php?id='.$id.'">'.$title.'</a></p>
                                    <p id="author"><a href="user.php?id='.$res["user"].'">'.$user.'</a></p>
                                    <p id="date">'.$date.'</p>
